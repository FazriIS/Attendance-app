...
@section('isi')
    <div class="container-fluid">
        <div class="card col-lg-12">
            <div class="mt-4 p-3">
                <form method="post" action="{{ url('/cuti/proses-edit/' . $data_cuti_user->id) }}"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            @endphp
                            <label for="nama_cuti">Leave Name</label>
                            <select class="form-control selectpicker @error('nama_cuti') is-invalid @enderror"
                                id="nama_cuti" name="nama_cuti" data-live-search="true">
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <input type="datetime" class="form-control @error('tanggal') is-invalid @enderror"
                                name="tanggal" id="tanggal" value="{{ old('tanggal', $data_cuti_user->tanggal) }}">
                            @error('tanggal')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col">
                            <label for="foto_cuti">Upload Photo</label>
                    ...
                    <div class="form-row">
                        <div class="col">
                            <label for="alasan_cuti">Leave Reason</label>
                            <input type="text" class="form-control @error('alasan_cuti') is-invalid @enderror"
                                id="alasan_cuti" name="alasan_cuti"
                                value="{{ old('alasan_cuti', $data_cuti_user->alasan_cuti) }}">
                            @error('alasan_cuti')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>

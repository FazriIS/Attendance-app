                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                            <b>Telephon</b> <a class="float-right">{{ $karyawan->telepon }}</a>
                            </li>
                        </ul>
                    </div>
                    <!-- /.card-body -->
                        ...
                        <div class="tab-content">
                            <div class="active tab-pane" id="settings">
                                <form method="post" action="{{ url('/pegawai/proses-edit/'.$karyawan->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_dadakan">Sudden Leave</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_menikah">Leave Married</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="izin_telat">Late Permission</label>

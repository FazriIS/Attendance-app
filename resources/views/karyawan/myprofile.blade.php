                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            ...
                            <li class="list-group-item">
                            <b>Telephon</b> <a class="float-right">{{ auth()->user()->telepon }}</a>
                            </li>
                        </ul>
                    </div>
                </div>
                                ...
                                <form method="post" action="{{ url('/my-profile/update/'.auth()->user()->id) }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col">
                                            ...
                                            ?>
                                            <label for="status_nikah">Martial Status</label>
                                    ...
                                    <div class="form-row">
                                        <div class="col">
                                            <label for="cuti_dadakan">Remainder of Unannounced Leave</label>
                                            <input type="text" class="form-control" value="{{ auth()->user()->cuti_dadakan }}" disabled>
                                        </div>
                                        <div class="col">
                                            <label for="cuti_bersama">Remainder of Shared Leave</label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="cuti_menikah">Remaining Marriage Leave</label>
                                            <input type="text" disabled class="form-control" value="{{ auth()->user()->cuti_menikah }}">
                                        </div>
                                        <div class="col">
                                            <label for="cuti_diluar_tanggungan">Remaining leave is not dependent</label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="cuti_khusus">Remaining Special Leave</label>
                                            <input type="text" disabled class="form-control" value="{{ auth()->user()->cuti_khusus }}">
                                        </div>
                                        <div class="col">
                                            <label for="cuti_melahirkan">Remaining Maternity Leave</label>
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <label for="izin_telat">Remaining Late Permits</label>
                                            <input type="text" disabled class="form-control" value="{{ auth()->user()->izin_telat }}">
                                        </div>
                                        <div class="col">
                                            <label for="izin_pulang_cepat">Remaining Permit to Go Home Early</label>

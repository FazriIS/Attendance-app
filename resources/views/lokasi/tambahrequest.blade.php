            ...
            <div class="p-4">
                ...
                <form method="post" action="{{ url('/request-location/tambah-proses') }}">
                    @csrf
                        ...
                        <div class="form-group">
                            <label for="lat_kantor">Office Latitude</label>
                        ...
                        <div class="form-group">
                            <label for="long_kantor">Office Longitude</label>
            ...
            <div class="p-4">
                ...
                <form method="post" action="{{ url('/request-location/tambah-proses') }}">
                    @csrf
                        ...
                        <input type="hidden" name="status" value="pending">
                        <input type="hidden" name="created_by" value="{{ auth()->user()->id }}">
                        <button type="submit" class="btn btn-success float-left"><i class="fa fa-map-marker-alt"></i> Get My Location Right Now</button>
                </form>
            </div>
        </div>
    </div>

...
@section('auth')
    <div class="login-logo">
        ...
        <br>
        <a href="{{ url('/register') }}" style="color: antiquewhite">Online Absent</a>
    </div>
            ...
            <form action="{{ url('/register-proses') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                        placeholder="Nama Pegawai" name="name" value="{{ old('name') }}">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control @error('telepon') is-invalid @enderror" placeholder="Phone"
                ...
                <div class="input-group mb-3">
                    <input type="datetime" class="form-control @error('tgl_lahir') is-invalid @enderror"
                        placeholder="Tanggal Lahir" name="tgl_lahir" value={{ old('tgl_lahir') }}>
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <div class="input-group mb-3">
                    <input type="datetime" class="form-control @error('tgl_join') is-invalid @enderror"
                        placeholder="Tanggal Masuk Perusahaan" name="tgl_join" value={{ old('tgl_join') }}>
                    <div class="input-group-append">
                        <div class="input-group-text">
                ...
                <div class="input-group mb-3">
                    ...
                    ?>
                    <select name="status_nikah" id="status_nikah" class="form-control selectpicker"
                ...
                <div class="input-group mb-3">
                    <input type="file" class="form-control @error('foto_karyawan') is-invalid @enderror"
                        placeholder="Foto Pegawai" name="foto_karyawan" value="{{ old('foto_karyawan') }}">
                    <div class="input-group-append">
                        <div class="input-group-text">

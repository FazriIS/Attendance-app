...
@section('isi')
    @php
        ...
        if ($bulan == '01') {
            ...
            return 'Tidak termasuk dalam bulan';
        }
    ...
    <div class="ml-2 mr-2">
        <div class="card p-4" style="border-radius: 20px">
            ...
            <center>
                <div class="row mt-4">
                    <div class="col">
                        <a href="{{ url('/absen') }}" class="btn btn-lg"
                            style="background-color: crimson; border-radius: 20px"><i class="fa fa-camera"
                                style="color: white"></i></a>
                        <p class="mt-2"><b style="font-size: 14px">Absen</b></p>
                    </div>
                    <div class="col">
                        <a href="{{ url('/my-absen') }}" class="btn btn-lg"
                            style="background-color: rgb(211, 160, 94); border-radius: 20px"><i class="fa fa-user-secret"
                                style="color: white"></i></a>
                        <p class="mt-2"><b style="font-size: 14px">My Absen</b></p>
                    </div>
                    <div class="col">
                        <a href="{{ url('/cuti') }}" class="btn btn-lg"
                            style="background-color: rgb(66, 91, 190); border-radius: 20px"><i class="fa fa-hourglass-half"
                                style="color: white"></i></a>
                        <p class="mt-2"><b style="font-size: 14px">Cuti</b></p>
                    </div>
                    <div class="col">
                        <a href="{{ url('/my-dokumen') }}" class="btn btn-lg"
                            style="background-color: rgb(57, 112, 78); border-radius: 20px"><i class="fa fa-folder"
                                style="color: white"></i></a>
                ...
                <div class="col">
                    <div class="card p-3" style="background-color: rgb(227, 229, 228); border-radius: 20px;">
                        <div class="row">
                            ...
                            <div class="col">
                                <h6><b>Cuti</b></h6>
                                {{ auth()->user()->MappingShift->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])->where('status_absen', '=', 'Cuti')->count() }}
                                Hari
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                @php
                                    $total_telat = auth()
                                        ->user()
                                        ->MappingShift->whereBetween('tanggal', [$tanggal_mulai, $tanggal_akhir])
                                        ->sum('telat');
